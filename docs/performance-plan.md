...
- Viewer charge une preview depuis le cache miniature avant l image 2048 px, ignore les reponses obsoletes, et adapte sa taille initiale au ratio de la photo.
